...
(
   ...
   always @(posedge clk or posedge rst) begin
      if (rst==1'b1) begin
          ...
          if ((full==1'b0) && (wr_vld==1'b1)) begin //if (!full && wr_vld) begin
              fifo_tail <= next_tail;
   ...
   always @(posedge clk or posedge rst) begin
      if (rst==1'b1) begin
          ...
          if ((empty==1'b0) && (rd_rdy==1'b1)) begin //if (!empty && rd_rdy) begin
              fifo_head <= next_head;
   ...
   always @(posedge clk or posedge rst) begin
      if (rst==1'b1) begin
         ...
         if ((wr_vld==1'b1)&&(full==1'b0)&&((rd_rdy==1'b0)||((rd_rdy==1'b1)&&(empty==1'b1)))) begin //if (wr_vld&&!full&&(!rd_rdy||(rd_rdy&&empty))) begin
             rd_cnt <= rd_cnt + 1;
         end else
         if ((rd_rdy==1'b1)&&(empty==1'b0)&&((wr_vld==1'b0)||((wr_vld==1'b1)&&(full==1'b1)))) begin //if (rd_rdy&&!empty&&(!wr_vld||(wr_vld&&full))) begin
             rd_cnt <= rd_cnt - 1;
         end
      end
   end
